...
LOCATIONS = {
    'ALAKNANDA A/C WITH BHAGIRATHI AT DEVPRAYAG': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Devprayag.csv",
        'lat': 30.140504, 'lon': 78.597358
    },
    'MANDAKINI B/C ALKALNADA AT RUDRAPRAYAG': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Rudraprayag.csv",
        'lat': 30.290028, 'lon': 78.979932
    },
    'GANGA AT HARIDWAR D/S, UPPER GANGA CANAL D/S BALKUMARI MANDIR, AJEETPUR, HARIDWAR ': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Haridwar.csv",
        'lat': 29.945254, 'lon': 78.164675
    },
    'GANGA AT KANNAUJ U/S (RAJGHAT), U.P': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Kannauj.csv",
        'lat': 27.010953, 'lon': 79.986442
    },
    'GANGA AT BITHOOR (KANPUR), U.P.': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Kanpur.csv",
        'lat': 26.610906, 'lon': 80.275419
    },
    'GANGA AT ALLAHABAD D/S (SANGAM), U.P': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Prayagraj.csv",
        'lat': 25.419206, 'lon': 81.900522
    },
    'GANGA AT VARANASI D/S (MALVIYA BRIDGE), U.P ': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Ganga at Varanasi.csv",
        'lat': 25.321486, 'lon': 83.035285
    },
    'GANGA AT TRIGHAT (GHAZIPUR), U.P': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Ganga at ghazipur.csv",
        'lat': 25.578175, 'lon': 83.609594
    },
    'GANGA AT GULABI GHAT, PATNA': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Ganga at Gulabi Ghat.csv",
        'lat': 25.620356, 'lon': 85.179995
    },
    'GANGA AT U/S BHAGALPUR NEAR BARARIGHAT': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Ganga at Bhagalpur.csv",
        'lat': 25.271603, 'lon': 87.025665
    },
    'KOLKATA, WEST BENGAL ': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Ganga at Dakshineshwar.csv",
        'lat': 22.632682, 'lon': 88.355369
    },
    'KOLKATA, WEST BENGAL ': {
        'file_path': r"C:\Users\ashis\Ganga_Project\Ganga_Project\Ganga at Howrah.csv",
...
def load_model_for_parameter(parameter):
    ...
    parameter_model_paths = {
        "Biochemical Oxygen Demand": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Biochemical_Oxygen_Demand_water_quality_lstm_model.keras",
        "Dissolved Oxygen": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Dissolved_Oxygen_water_quality_lstm_model.keras",
        "pH": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\pH_water_quality_lstm_model.keras",
        "Turbidity": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Turbidity_water_quality_lstm_model.keras",
        "Nitrate": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Nitrate_water_quality_lstm_model.keras",
        "Fecal Coliform": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Fecal_Coliform_water_quality_lstm_model.keras",
        "Fecal Streptococci": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Fecal_Streptococci_water_quality_lstm_model.keras",
        "Total Coliform": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Total_Coliform_water_quality_lstm_model.keras",
        "Conductivity": r"C:\Users\ashis\Ganga_Project\Ganga_Project\models\Conductivity_water_quality_lstm_model.keras"
    }
